            ...
            <div class="card-body">
                ...
                <form action="" method="GET">
                    <div class="mb-3 d-flex gap-3 justify-content-between">
                        <div>
                            <a href="{{ route('admin.guru_piket.create') }}" class="btn btn-sm btn-primary">Tambah</a>
                        </div>
                        <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form onsubmit="return confirm('Yakin akan dihapus?')"
                                            action="{{ route('admin.guru_piket.destroy', $item->id) }}" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <a href="{{ route('admin.guru_piket.edit', $item->id) }}"
